...
// clase que sirve para hacer pagging para una tabla de cualquier tipo 
function PagingService(resultList) {
    ...
    self.fetchEntities = function (event) {
        ...
        $.ajax({
            ...
            $('.body-content').prepend('<div class="alert alert-danger"><strong>¡Error!</strong> Ocurrio un error al obtener los datos.</div>');
        });
    };
